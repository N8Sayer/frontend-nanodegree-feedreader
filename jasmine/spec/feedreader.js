  ...
  */
  ...
  describe('The menu', function() {
     ...
     */
      ...
      */
      // Click the button, check if still has menu class for hidden, click again, check again
  ...
  describe('New Feed Selection', function() {
    ...
    // Before the it function, run loadFeed twice with 0 and 1 index to check if it loads different feeds
    beforeEach(function(done) {
      loadFeed(0, function() {
